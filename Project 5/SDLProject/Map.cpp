...
bool Map::is_solid(glm::vec3 position, float *penetration_x, float *penetration_y)
{
    ...
    *penetration_y = 0;
    ...
    // Define some tiles as non-solid, only for view
    std::vector<int> nonSolidTiles = {0,7, 16,17,19,20,25,26,35,41,42,43,44,47,48,50,51,52,53,54,55,56,57,59,60,61,62,63,64,65,66,67,68,70,73,74,75,78,79};
